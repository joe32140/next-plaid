...
// Every parameter is a corpus shape a benchmark varies independently -- dim and
// cluster count especially, since they change which codec arithmetic and which
// candidate-set size is under test. A struct would move the same eight values
// behind a name without making a caller clearer.
